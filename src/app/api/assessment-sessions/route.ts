...
export async function GET(req: NextRequest) {
  ...
  const { data, error } = await supabase
    ...
    .select('id, token, templateId, template:assessment_templates(name, kind, assessmentType, estimatedMin), expiresAt, startedAt, submittedAt, score, outcome, scoreBreakdown, sentBy, createdAt')
